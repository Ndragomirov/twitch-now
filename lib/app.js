...
var User = Backbone.Model.extend({
  initialize      : function (){
    ...
    this.set({
      ...
      "logo"         : "http://static-cdn.jtvnw.net/jtv_user_pictures/xarth/404_user_70x70.png",
      "name"         : "Twitchuser"
    });
  ...
  populateUserInfo: function (cb){
    ...
    twitchApi.send("user", {}, function (err, res){
      if ( !err ) {
        self.set({
          logo: res.logo || "http://static-cdn.jtvnw.net/jtv_user_pictures/xarth/404_user_70x70.png",
...
var DonationCollection = Backbone.Collection.extend({
  ...
  updateData: function (){
    var url = "http://localhost:3366/payments";
    var self = this;
    $.ajax({ method: "GET", url: url})
