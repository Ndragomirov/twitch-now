...
app.sendNotification = function (streamList) {
  //Chrome 28+
  var OS = app.getOSName();
  var chromeVersion = app.getChromeVersion();
  var richNotificationsSupported = !!chrome.notifications;
//    var richNotificationsSupported = false;

  if (richNotificationsSupported && chromeVersion >= 28 && (OS == "Windows")) {
    var displayCount = 5;
...
var StreamCollection = Pagination.extend({
