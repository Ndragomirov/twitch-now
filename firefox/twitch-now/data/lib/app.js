(function (){
  ...
  if ( root.utils.browser == "chrome" && !root.utils.background ) {
    return;
  }
  ...
  var localStorage = root.localStorage = root.localStorage || {};
  ...
  bgApp.getChromeVersion = function (){
  ...
  var User = Backbone.Model.extend({
    initialize      : function (){
      ...
      this.set({
        ...
        "logo"         : utils.runtime.getURL("icons/default_userpic.png"),
        "name"         : "Twitchuser"
      });
    ...
    populateUserInfo: function (cb){
      ...
      twitchApi.send("user", {}, function (err, res){
        if ( !err ) {
          self.set({
            logo: res.logo || utils.runtime.getURL("icons/default_userpic.png"),
